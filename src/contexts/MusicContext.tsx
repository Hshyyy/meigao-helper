...
const playlist: Track[] = [
  ...
  { name: "BoA - Only One", artist: "BoA", file: "./music/Only One - BoA.mp3", cover: "./music/covers/Only One.jpg" },
  ...
  { name: "We Don't Talk Anymore", artist: "Charlie Puth、Selena Gomez", file: "./music/We Don't Talk Anymore (Mr. Collipark Remix) - Charlie Puth、Selena Gomez.mp3", cover: "./music/covers/We Don't Talk Anymore.jpg" },
  ...
  { name: "暮雨2.0", artist: "HYPEEZY、CHECKYHON、邓乐怡", file: "./music/暮雨2.0 (那往事就到此) - HYPEEZY、CHECKYHON、邓乐怡.mp3", cover: "./music/covers/暮雨2.0.svg" },
