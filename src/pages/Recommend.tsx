          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-20">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="number" min={0} max={120} value={profile.toefl || ""} onChange={(e) => update("toefl", Number(e.target.value))} placeholder="例如：100" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" required />
              ...
              <div>
                ...
                <input type="number" min={0} max={99} value={profile.ssat || ""} onChange={(e) => update("ssat", Number(e.target.value))} placeholder={canSkipSSAT ? "不填则免 SSAT 学校优先" : "例如：85"} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" required={!canSkipSSAT} />
              ...
              <div>
                ...
                <input type="number" min={0} max={profile.schoolType === "public" ? 100 : 4} step={profile.schoolType === "public" ? 1 : 0.1} value={profile.gpa || ""} onChange={(e) => update("gpa", Number(e.target.value))} placeholder={profile.schoolType === "public" ? "例如：88" : "例如：3.5"} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" required />
                <p className="text-xs text-gray-400 mt-1">
