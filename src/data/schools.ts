...
export const schools: School[] = [
  {
    ...
    description: "创建于1778年，是美国最古老的寄宿高中之一。位于马萨诸塞州安多佛镇，距离波士顿仅21英里。学校以严谨的学术氛围和全人教育理念著称，培养了众多政界、商界和学术界精英。",
  ...
  },
  {
    ...
    studentCount: 1100,
    studentTeacherRatio: "5:1",
    description: "创建于1781年，与Andover并称为美国最顶尖的两所寄宿高中。位于新罕布什尔州埃克塞特镇，以哈克尼斯圆桌教学法闻名于世。学校拥有全美最大的高中图书馆，藏书超过16万册。",
  ...
  },
  {
    ...
    description: "创建于1890年，位于康涅狄格州沃灵福德镇，距离纽约和波士顿均约2小时车程。肯尼迪总统的母校，以人文与STEM并重的教育理念著称。学校国际生比例较高，文化多元包容。",
